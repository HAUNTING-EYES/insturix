      ...
      <div className="grid grid-cols-1 gap-3 p-2">
        {Object.entries(textOverlayTemplates).map(([key, option]) => (
          <div
            ...
            className="group relative overflow-hidden border-2 bg-muted rounded-md border-border transition-all duration-200 hover:border-primary/60 cursor-pointer"
          >
            {/* Preview Container */}
