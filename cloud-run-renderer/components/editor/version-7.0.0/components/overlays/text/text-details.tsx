  ...
  return (
    <div className="space-y-4">
      ...
      <div className="flex flex-col gap-2 ">
        {/* Preview */}
        <div className="flex flex-col gap-2 bg-zinc-100/90 dark:bg-zinc-800">
          <div
            style={{
      ...
      <Tabs defaultValue="settings" className="w-full">
        <TabsList className="w-full grid grid-cols-2 bg-zinc-100/50 dark:bg-zinc-800/50 backdrop-blur-sm rounded-sm border border-zinc-200 dark:border-zinc-700 gap-1">
          <TabsTrigger
            value="settings"
