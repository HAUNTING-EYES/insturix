        ...
        <>
          <form onSubmit={handleSearch} className="flex gap-2">
            <Input
              ...
              value={searchQuery}
              className="flex-1 h-8 sm:h-10 text-xs sm:text-sm bg-muted border-border text-foreground placeholder:text-muted-foreground focus-visible:ring-ring md:text-base"
        ...
        <ScrollArea className="flex-1 scrollbar-hide overflow-hidden [&_[data-radix-scroll-area-scrollbar]]:!hidden">
          <div className="grid grid-cols-2 sm:grid-cols-1 gap-2 scrollbar-hide">
            {isLoading ? (
              ...
              <div className="col-span-2 sm:col-span-1 flex flex-col items-center justify-center py-4 sm:py-8 text-muted-foreground text-xs sm:text-sm">
                No templates found
              </div>
            )}
          </div>
