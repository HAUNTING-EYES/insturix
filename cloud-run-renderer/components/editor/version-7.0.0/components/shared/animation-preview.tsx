  ...
  return (
    <button
      ...
      className={`relative aspect-square w-full rounded-lg border ${
        isSelected
          ? "border-zinc-500 bg-zinc-500/10 shadow-[0_0_0_1px_rgba(113,113,122,0.5)]"
        ...
        <div className="relative h-6 w-6">
          ...
          <div
            className={`absolute inset-0 rounded-full ${
              isSelected
                ? "border-zinc-500 border-dashed border-2"
  ...
  return (
    ...
    >
      <div className="border border-gray-200 dark:border-gray-700 rounded-md overflow-hidden">
        ...
        <CollapsibleContent>
          <div className="p-2 bg-white dark:bg-gray-900/60">
