...
import { prepareRenderInputProps } from "@/components/editor/version-7.0.0/lambda-helpers/prepare-render-input";
...
export const POST = executeApi<RenderMediaOnLambdaOutput, typeof RenderRequest>(
  ...
  async (req, body) => {
    ...
    try {
      const inputProps = await prepareRenderInputProps(body.inputProps);
