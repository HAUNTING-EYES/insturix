    ...
    return (
        <div className="min-h-screen bg-zinc-50 dark:bg-[rgb(var(--surface-0))] relative">
            ...
            <div className="absolute inset-0 overflow-hidden pointer-events-none">
                <svg className="absolute w-full h-64 opacity-[0.03] dark:opacity-[0.05]" viewBox="0 0 1440 320">
                    <motion.path
                        initial={{ d: "M0,192L48,165.3C96,139,192,85,288,80C384,75,480,117,576,149.3C672,181,768,203,864,186.7C960,171,1056,117,1152,101.3C1248,85,1344,107,1392,117.3L1440,128L1440,0L1392,0C1344,0,1248,0,1152,0C1056,0,960,0,864,0C768,0,672,0,576,0C480,0,384,0,288,0C192,0,96,0,48,0L0,0Z" }}
                        animate={{
                            d: [
                ...
                >
                    ...
                    <div className="relative flex flex-col items-center text-center space-y-4">
                        ...
                        <p className="text-zinc-600 dark:text-zinc-400 max-w-2xl">
                            Learn how to make the most of our platform with detailed tutorials and guides
                        </p>
                            ...
                            <div className="grid md:grid-cols-2 gap-6">
                                {category.items.map((item, itemIndex) => (
                                    <Link href="#" key={item.title}>
                                        <Card className="p-6 h-full bg-white/50 dark:bg-[rgb(var(--surface-1))]/50 backdrop-blur-sm border-zinc-200/40 dark:border-[rgb(var(--border-light))]/20 transition-all duration-300 hover:scale-[1.02] hover:shadow-lg">
