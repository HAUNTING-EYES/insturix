...
const Particles: React.FC<ParticlesProps> = ({
  ...
  useEffect(() => {
    ...
    let rgb = hexToRgb(propsRef.current.color)
    ...
    const handleResize = () => {
      rgb = hexToRgb(propsRef.current.color)
      initCanvas()
    }
    ...
    const animate = () => {
      clearContext()
      const { vx, vy, staticity, ease } = propsRef.current
  ...
  }, []) // Empty dependency array - all props accessed via propsRef
