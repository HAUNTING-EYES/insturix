...
const AnimatedCharacter = memo(({ char, index }: { char: string; index: number }) => (
  <motion.span
    custom={index}
...
export default function TypingAnimation({
  ...
  }, [isTypingComplete, messages, currentMessageIndex, characterDelay, displayDuration, shouldLoop, onComplete]);
