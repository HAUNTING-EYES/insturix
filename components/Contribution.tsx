  ...
  const contributionTypes = [
    {
      title: "Share Ideas",
      icon: Lightbulb,
      description: "Have innovative ideas for new features or improvements? We'd love to hear them.",
      link: "/contactus",
    ...
    },
    {
      ...
      icon: Code,
      description: "Are you a developer? Join our team and help build the future of our platform.",
      link: "/contactus",
    ...
    },
    {
      title: "Feedback",
      icon: MessageSquare,
      description: "Your feedback helps us improve. Share your experience and suggestions.",
      link: "/contactus",
      ...
      <div className="container mx-auto px-4 py-16 relative">
        ...
        >
          ...
          <p className="text-zinc-600 dark:text-zinc-400 mb-12">
            Help us shape the future of our platform. Your contributions make a difference.
          </p>
