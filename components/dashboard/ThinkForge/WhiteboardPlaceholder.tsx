      ...
      >
        <div className="relative">
            ...
            <div className="relative h-20 w-20 bg-[#1C1B19]/80 rounded-2xl flex items-center justify-center border border-[#1C1B19] shadow-2xl">
                <Brain className="h-10 w-10 text-[#D4A652]" />
            </div>
        ...
        <div className="space-y-2">
            <h2 className="text-2xl font-semibold text-[#ECE9E1]">Whiteboard Coming Soon</h2>
            <p className="text-[#7A776E] leading-relaxed">
                We're building a visual canvas to help you map out scenes, organize shots, and brainstorm visually alongside your script.
            </p>
        </div>
