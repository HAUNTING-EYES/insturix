...
export function useExportPipeline(
  ...
  const clickatronContextRequestBody = useMemo(() => ({
    ...
    logoTreatment: clickatronVisualChoices.logoTreatment,
    logoPlacement: clickatronVisualChoices.logoPlacement,
    logoScale: clickatronVisualChoices.logoScale,
    ...
    clickatronVisualChoices.logoPlacement,
    clickatronVisualChoices.logoScale,
    clickatronVisualChoices.logoTreatment,
