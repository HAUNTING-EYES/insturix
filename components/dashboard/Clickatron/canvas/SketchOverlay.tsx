      ...
      {textInputPos && tool === "text" && (
        ...
        >
          ...
          <textarea
            ...
            className="block min-w-[80px] max-w-[280px] min-h-[28px] px-2 py-1 text-base bg-black/60 border border-white/30 rounded focus:outline-none focus:ring-1 focus:ring-white/50 resize-none placeholder:text-zinc-400"
            style={{
