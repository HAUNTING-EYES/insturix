...
export function CompactAnalytics() {
  ...
  // Read analytics directly from TanStack cache/query (unified pattern)
  const { data } = useQuery({
  ...
  const activeAnalyses = data?.activeAnalyses ?? 0;
        ...
        <div className="flex items-center justify-between">
          ...
          <div className="flex items-center gap-3 sm:gap-4">
            <div className="text-center">
              <div className="text-sm font-semibold text-zinc-100">{monthlyAnalyses}</div>
              <div className="text-xs text-zinc-500">This month</div>
            </div>
            <div className="text-center">
              <div className="text-sm font-semibold text-zinc-100">{activeAnalyses}</div>
