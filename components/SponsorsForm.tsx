  ...
  const formik = useFormik({
    ...
    onSubmit: (values, { resetForm }) => {
      ...
      try {
        toast({
          title: "Message Sent!",
          description: "Thank you for Reaching us Out. We'll get back to you soon.",
          variant: "default",
      ...
      <div className="container mx-auto px-4 py-16 relative">
        ...
        >
          ...
          <p className="text-zinc-600 dark:text-zinc-400 mb-8">
            You Want to support us? Fill the form below and we will get back to you soon.
          </p>
                ...
                <form onSubmit={formik.handleSubmit} className="space-y-4">
                  ...
                  <div className="grid sm:grid-cols-2 gap-4">
                    <div>
                      ...
                      <Input
                        ...
                        className={formik.touched.telephone && formik.errors.telephone ? "border-red-500" : ""}
                      />
                      {formik.touched.telephone && formik.errors.telephone && (
                        <p className="mt-1 text-sm text-red-500">{formik.errors.telephone}</p>
                      )}
                    </div>
                    <div>
                        ...
                        <PopoverTrigger asChild>
                          <Button
                            ...
                            className={`w-full justify-between ${
                              formik.touched.budget && formik.errors.budget ? "border-red-500" : ""
                            }`}
                          >
                            {formik.values.budget > 0 ? `₹${formik.values.budget.toLocaleString()}` : "Select budget"}
                        ...
                        <PopoverContent className="w-80">
                          <div className="grid gap-4">
                            ...
                            <Slider
                              ...
                              onValueChange={(value) => formik.setFieldValue("budget", value[0])}
                            />
                          </div>
                        </PopoverContent>
                      </Popover>
                  ...
                  <div>
                    ...
                    <Input
                      ...
                      className={formik.touched.Help && formik.errors.Help ? "border-red-500" : ""}
                    />
                    {formik.touched.Help && formik.errors.Help && (
                      <p className="mt-1 text-sm text-red-500">{formik.errors.Help}</p>
                    )}
                  </div>
                  ...
                  <div>
                    ...
                    <Textarea
                      ...
                      className={`h-32 ${formik.touched.message && formik.errors.message ? "border-red-500" : ""}`}
                    />
