            ...
            >
              <div className="relative mb-8 sm:mb-12 w-full">
                <div className="absolute -inset-x-20 -inset-y-10 z-0 opacity-30 blur-2xl">
                  <div className="absolute inset-0 bg-linear-to-r from-[rgb(var(--primary))/10] to-[rgb(var(--secondary))/10] [mask-image:radial-gradient(farthest-side_at_top,white,transparent)]" />
                </div>
              ...
              >
                Securing the Future of Content Creators. Your all-in-one
                platform for creator protection, AI-powered tools, and brand
                collaborations
              </motion.p>
              ...
              >
                ...
                <Link
                  href="/about"
                  className="w-full sm:w-auto group relative rounded-full border border-[rgb(var(--foreground))/10 bg-[rgb(var(--background))/50] px-8 py-3 text-sm font-semibold backdrop-blur-xs transition-all duration-300 ease-out hover:scale-105 hover:bg-[rgb(var(--foreground))/5] active:scale-[0.98]"
                >
