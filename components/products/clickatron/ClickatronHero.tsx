...
import { ArrowRight, Sparkles, Image as LucideImage, Edit, Palette } from "lucide-react";
  ...
  return (
    <section ref={targetRef} className="relative min-h-screen flex items-center justify-center overflow-hidden bg-white dark:bg-black pt-16">
      ...
      >
        ...
        >
          Clickatron is your thumbnail generator and editor that combines AI prompt optimization, a high-fidelity render pipeline, and Insturix automation so every visual looks intentional.
        </motion.p>
        ...
        >
          <div className="flex items-center gap-2">
            ...
            <LucideImage className="w-4 h-4 text-purple-500" aria-label="AI Design Stack icon" />
            <span>Advanced AI design stack</span>
          </div>
          <div className="flex items-center gap-2">
            <Edit className="w-4 h-4 text-fuchsia-500" aria-label="Inline editor icon" />
            <span>Inline AI-powered editor</span>
          </div>
          <div className="flex items-center gap-2">
            <Palette className="w-4 h-4 text-purple-400" aria-label="Brand palette icon" />
        ...
        >
          <LinkNext href="/dashboard/clickatron">
            ...
            >
              Start Visualising<ArrowRight className="ml-2 w-5 h-5" />
            </Button>
          </LinkNext>
        </motion.div>
