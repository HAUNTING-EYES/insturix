...
import { Sparkles, ChartBar, Building, Video, ChartPie, HandCoins } from "lucide-react";
...
export default function MeditronFeatures() {
  ...
  return (
    <section ref={targetRef} className="relative py-32 bg-white dark:bg-black">
      ...
      <div className="absolute inset-0 z-0">
        ...
        <motion.div style={{ y: y1 }} className="absolute inset-0 bg-gradient-to-r from-green-800/10 via-transparent to-emerald-800/10 blur-3xl" />
      ...
      >
        ...
        <motion.div variants={itemVariants} className="text-center mb-20">
          <div className="inline-flex items-center gap-2 px-4 py-2 rounded-md border border-green-500/50 bg-green-500/10 text-green-700 dark:text-green-300 text-sm font-medium mb-6">
        ...
        >
          {features.map((feature) => (
            ...
            >
              <div className="relative h-full p-8 rounded-2xl bg-white/80 dark:bg-neutral-900/80 backdrop-blur-sm border border-neutral-200 dark:border-neutral-800 transition-all duration-300 group-hover:border-green-500/50 group-hover:bg-white dark:group-hover:bg-neutral-900">
                {/* Icon */}
        ...
        >
          <div className="inline-flex items-center gap-4 px-6 py-3 rounded-md bg-gray-100/80 dark:bg-neutral-900/80 border border-neutral-200 dark:border-neutral-800">
            ...
            <span className="text-neutral-700 dark:text-neutral-300 font-medium">
              Ready to connect with your next sponsor?
            </span>
          </div>
        </motion.div>
      </motion.div>
