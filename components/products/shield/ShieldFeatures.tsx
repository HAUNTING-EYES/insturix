...
import { Shield, Gavel, FileText, AlertTriangle, Megaphone, Sparkles } from "lucide-react";

const features = [
  {
    icon: Gavel,
    title: "Copyright & Takedown Support",
    description: "Support against unfair copyright claims or video takedowns. Instantly deploys counterclaims using AI-generated legal templates.",
    gradient: "from-purple-400 to-fuchsia-500",
    delay: 0.1,
  },
  {
    icon: AlertTriangle,
    title: "Defamation & Misinformation Guard",
    description: "Alerts and helps you respond to false allegations or damaging content using AI-powered scanning and case-building.",
    gradient: "from-fuchsia-400 to-purple-400",
    delay: 0.2,
  },
  {
    icon: FileText,
    title: "Automated Legal Support",
    description: "Access to basic legal documentation, notices, and takedown templates powered by AI. Smart prompts generate drafts tailored to each case.",
  ...
  },
  {
    ...
    description: "Monitors digital chatter using sentiment analysis. Provides alerts for potential PR threats and recommended actions.",
    gradient: "from-fuchsia-500 to-purple-300",
    delay: 0.4,
  },
  {
    icon: Sparkles,
    title: "AI Dispute Handler (Coming Soon)",
    description: "Engage brands or platforms with smart, pre-trained response systems for resolution.",
...
export default function ShieldFeatures() {
      ...
      >
        ...
        <motion.div variants={itemVariants} className="text-center mb-20">
          ...
          <p className="text-lg text-neutral-600 dark:text-neutral-300 max-w-3xl mx-auto leading-relaxed">
            Shield is your digital legal and reputation support system. Defend your content, reputation, and business with AI-powered tools.
          </p>
        </motion.div>
