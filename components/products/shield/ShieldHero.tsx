      ...
      >
        ...
        <motion.div variants={itemVariants} className="mb-8">
          <div className="inline-flex items-center gap-2 px-4 py-2 rounded-md border border-purple-500/50 bg-purple-500/10 text-purple-700 dark:text-purple-300 text-sm font-medium">
            ...
            Smart digital support & legal defense for creators and businesses.
          </div>
        </motion.div>
        ...
        >
          <div className="flex items-center gap-2">
            ...
            <span>Copyright & Takedown Support</span>
          </div>
          <div className="flex items-center gap-2">
            <AlertTriangle className="w-4 h-4 text-fuchsia-500" />
            <span>Defamation & Misinformation Guard</span>
          </div>
          <div className="flex items-center gap-2">
            <FileText className="w-4 h-4 text-purple-400" />
            <span>Automated Legal Support</span>
          </div>
          <div className="flex items-center gap-2">
          ...
          <div className="relative rounded-xl overflow-hidden bg-black aspect-video">
            <div className="absolute inset-0 bg-gradient-to-br from-purple-400/10 via-transparent to-fuchsia-400/10 flex items-center justify-center">
              <div className="text-center text-white">
                <Shield className="w-16 h-16 mx-auto mb-4 opacity-70" />
                <p className="text-xl font-semibold">See Shield in Action</p>
                <p className="text-sm opacity-60 mt-2">Your digital support system</p>
              </div>
            </div>
          </div>
        </motion.div>
