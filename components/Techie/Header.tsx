...
export default function Header() {
  return (
    <header className="relative bg-black dark:bg-black min-h-[75vh] pt-16 flex items-center">
        ...
        <div className="flex flex-col lg:flex-row items-center justify-between gap-6 lg:gap-10">
          <div className="w-full lg:w-1/2 text-center lg:text-left lg:py-12">
            <div className="relative space-y-8">
              ...
              <h1 className="relative text-4xl sm:text-5xl lg:text-6xl xl:text-7xl font-bold text-white [&_span]:mb-1 [&_span]:inline-block">
              ...
              <p className="relative text-base sm:text-lg text-neutral-300/90 max-w-xl mx-auto lg:mx-0 [&:not(:first-child)]:mt-4">
              ...
              <div className="relative flex items-center justify-center lg:justify-start gap-4">
                <Button
                  variant="outline"
                  size="lg"
                  className="bg-white/10 backdrop-blur-sm border-white/20 text-white hover:bg-white/20 hover:border-white/30 group"
                >
