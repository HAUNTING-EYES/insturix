...
const perkRows = [
  ...
  {
    name: "Weekly Mixers & Leisure Sessions",
    key: "weeklyMixers",
              ...
              <div className="flex items-start space-x-3">
                ...
                <div>
                  ...
                  <p className="text-blue-300/80 text-sm">
                    You can only upgrade to higher plans. Downgrades aren&apos;t
                    available through purchase since you&apos;ve already paid
                    for your current tier. Contact support for plan changes or
                    cancellations.
                  </p>
                </div>
              </div>
                      ...
                      <div className="mb-6">
                        ...
                        {plan.savings && (
                          ...
                          >
                            ...
                            Save {selectedSymbol}
                            {plan.savings.toFixed(2)} per year
                          </motion.div>
                        )}
                        {plan.userType === currentUserPlan &&
                          currentPlanData && (
                        ...
                        return (
                          <Button
                            className={cn(
                              ...
                              `${getGradientClass("primaryDark")} hover:${getGradientClass("primaryHover")} text-white border-0`
                            )}
                            onClick={() => {
                      ...
                      >
                        <div className="flex items-center justify-center gap-2">
                          <div
                            ...
                            style={{ background: plan.color || "#8b5cf6" }}
                          />
                          {plan.name}
                        </div>
                      </th>
                ...
                <tbody>
                  {perkRows.map((perk) => (
                    ...
                    >
                      ...
                      {plans.map((plan) => (
                        <td
                          key={`${perk.key}-${plan.id}`}
                          className="p-4 text-center"
                        >
                          {creatorPerks[plan.userType]?.[
                            perk.key as keyof (typeof creatorPerks)[UserType.Free]
                          ] ? (
                            <div className="flex items-center justify-center">
