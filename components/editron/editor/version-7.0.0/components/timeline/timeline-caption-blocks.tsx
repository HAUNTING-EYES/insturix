  ...
  if (shouldShowLabel) {
    ...
    return (
      <div className="absolute inset-0 flex items-center z-20">
        <div className="flex items-center text-[9px] rounded px-1.5 py-0.5 mx-1 group-hover:mx-6 active:mx-6 selection:mx-6 transition-all duration-200 ease-in-out bg-zinc-900/90 text-zinc-200 min-w-0">
              ...
              return (
                <div
                  ...
                  className={`flex p-[3px] items-center justify-center mx-[1px] rounded-[3px] transition-all duration-150 ${
                    isWordActive ? "bg-zinc-500" : "bg-zinc-700/50"
                  }`}
                  style={{
                    width: `${wordWidth}%`,
                  }}
                >
                  <span
                    className={`truncate ${
                      isWordActive ? "text-white font-medium" : "text-zinc-200"
                    }`}
                    style={{
