            ...
            className={`group relative overflow-hidden rounded-lg border transition-all duration-200
              ${
                localOverlay?.template === key
                  ...
                  : "border-border hover:border-border/60 bg-muted/50 hover:bg-muted"
              }`}
          >
            {/* Preview Area with demo text */}
            <div className="relative aspect-[16/7] w-full overflow-hidden bg-zinc-900/90">
            ...
            <div className="flex items-center justify-between p-3 bg-background/50 backdrop-blur-sm">
              {/* Template Name and Status */}
              <div className="flex items-center gap-2">
                ...
                {localOverlay?.template === key && (
                  <span className="text-[10px] text-foreground font-medium bg-accent px-2 py-0.5 rounded-full">
                    Active
                  </span>
                )}
              </div>
