...
export default function Banner({ version }: BannerProps) {
  ...
  return (
    ...
    >
      <Link
        href="/"
        className="flex items-center text-white hover:text-zinc-500 transition-colors"
      >
      ...
      <div className="flex items-center ">
        <p className="flex items-center text-sm font-normal text-white ">
          <span className="inline-flex me-3 bg-zinc-500 rounded-full w-8 h-8 items-center justify-center flex-shrink-0">
            <Sparkles size={16} className="text-white" />
            <span className="sr-only">Sparkles icon</span>
          </span>
          <span className="font-medium">
            Version:{" "}
            <span className="inline font-bold text-zinc-500  decoration-zinc-500 decoration-solid">
              {version}
            </span>{" "}
