...
function makeSource(): MutableSource {
  ...
  const specs = [
    ...
    spec('apply_filter', { projectId: 'project-42', expectedProjectRevision: 'R44', overlayId: 42, targetRange: { startFrame: 600, endFrame: 720 }, effectPlan: { filterIntent: 'warmer' } }, { receipt: { status: 'PASS', projectRevision: 'R45' } }, [binding(5, 'set_keyframes', 'receipt.projectRevision', 'expectedProjectRevision', 'R44')], []),
  ];
