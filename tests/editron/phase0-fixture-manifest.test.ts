...
function signalAudit(overrides: Record<string, unknown> = {}) {
  const candidate = {
    ...
    sourcePacket: {
      ...
      visualSetupSignalKeys: ['enrichment.visual_setup_source', 'visual.environment', 'visual.shot_scale', 'visual.perception.text_presence_ratio'],
