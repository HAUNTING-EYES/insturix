...
source: insturix_vision.md
---

# Insturix Vision — The Complete North Star

> **Read this before making any architectural, UX, or product decision.**
...
- "To use feature X, you need to understand the profile system" -- VIOLATION
- "Moving a cut manually breaks beat-sync permanently" -- VIOLATION
- "User must select model before parse" -- VIOLATION
...
See also: [[Editron-Pipeline-Map]] for how these principles manifest in the pipeline architecture.
...
See also: [[CTO-3-Year-Plan]] for how personalization fits into the 3-year roadmap.
