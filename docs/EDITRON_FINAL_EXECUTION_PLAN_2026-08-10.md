...
programme code checkpoint represented by this ledger is `c69a845ea` on
...
3. **Stage 2.5 generalisation episodes:** the eight HOLD tasks are no longer
   ...
   deadline/cancel/tenant/approval-lineage gates (`c69a845ea`). Next add the
   authenticated approval wait/wake and event-history seam, bind ProjectService
