...
programme code checkpoint represented by this ledger is `b50f9f9fa` on
...
3. **Stage 2.5 generalisation episodes:** the eight HOLD tasks are no longer
   ...
   non-wired ProjectService proposal clone and durable diff receipt. Next bind
   concrete production operator ownership, reference-media and runtime-budget
   adapters, and add
