...
programme code checkpoint represented by this ledger is `8ecc87a1c` on
...
<!-- CURRENT RESUME CHECKPOINT: 8ecc87a1c. Deterministic proposal recovery, one
real cut_section owner, immutable reference-artifact resolution and the sealed
runtime-budget owner are research-proven. Next bind rendered-proof ownership
and expand concrete operator coverage; do not rerun paid cohorts without a
fresh zero-inference preflight plus explicit spend authorization. -->
