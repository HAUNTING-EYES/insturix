...
programme code checkpoint represented by this ledger is `aff06c8d4` on
...
3. **Stage 2.5 generalisation episodes:** the eight HOLD tasks are no longer
   ...
   review wait/wake revisions (`aff06c8d4`). Next bind ProjectService
