...
3. **Stage 2.5 generalisation episodes:** the eight HOLD tasks are no longer
   ...
   completed H03-C1. Adapt the existing sole runner, run zero-inference
   preflight and execute that identity first. Then test other
...
- [ ] **T7 (P1, bounded matrix)** — V2-2 — run repeated development and locked
  ...
  - Current gate (2026-08-22): H03 component-kind/translation contracts,
    ...
    unseen” claim and freezes 45 current-context qualification rows. Next
    connect its existing sole runner, preflight and execute it, then test
