...
programme code checkpoint represented by this ledger is `34d9da281` on
...
3. **Stage 2.5 generalisation episodes:** the eight HOLD tasks are no longer
   ...
   non-evaluations. Next test other dependency/invalidation shapes; force native, generated and
...
- [ ] **T7 (P1, bounded matrix)** — V2-2 — run repeated development and locked
  ...
  - Current gate (2026-08-22): H03 component-kind/translation contracts,
    ...
    brings the combined safety suite to 16/16, including latest-writer opaque
    revision consumption. Next test model-declared graphs against this shape,
    then context-resume and long-form/range trials; product integration waits
