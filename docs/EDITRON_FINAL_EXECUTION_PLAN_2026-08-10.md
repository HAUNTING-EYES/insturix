...
- **The sealed no-edit proof family is `RESEARCH_PROVEN` for HOLD-06/07/08.**
  ...
  ProjectService byte equality or rendered quality. Native HOLD-01/02/04/05 and
...
- **Stage 2.5 status remains `MODIFY_AND_PROCEED_RESEARCH`.** No production
  ...
  order is now: connect bounded real native and generated/hybrid proof adapters
  for the claims being scored; exercise those adapters, the completed no-edit
  family and the V2R-3 accounting
...
3. **V2-2 unseen holdouts and integration gate - initial requests bounded,
   ...
   research no-edit proof. Next connect real native proof for HOLD-01/02/04/05,
