...
- **Stage 2.5 status remains `MODIFY_AND_PROCEED_RESEARCH`.** No production
  ...
  paid-dispatch authorization bound to that receipt and the complete scripted
  gate; then run all eight sealed unseen holdouts,
