...
programme code checkpoint represented by this ledger is `1f22ef2f2` on
...
A shared durable lifecycle record exists at `1f22ef2f2`, but the episode is not
adapted to it. Authenticated worker ingress, fresh-process recovery, paid
...
3. **Stage 2.5 generalisation episodes:** the eight HOLD tasks are no longer
   ...
   the exact V4 episode checkpoint through the shared record at `1f22ef2f2`
   and prove zero-inference fresh-process claim/hydrate/suffix-only recovery;
...
- [ ] **T7 (P1, bounded matrix)** — V2-2 — run repeated development and locked
  ...
  - Current gate (2026-08-22): H03 component-kind/translation contracts,
    ...
    shared durable lifecycle record; episode adaptation, authenticated worker
    ingress, paid resumed inference and fresh-process recovery remain before
