...
| SEALED-16 | The current `buildSubjectAwareReframePlan` treats normalized subject centres as CSS `object-position` percentages and leaves skipped overlays in old absolute pixels after a canvas change. | CODE_DISPROVEN_BLOCKER | On the bound H05 16:9-to-9:16 geometry this clips the known subject box on 38/450 frames (worst 360x640 margin `-20.53px`) and cannot preserve the declared top-right-five-percent logo relation. The public sealed evidence also omits complete box/raster facts. Do not mark H05 PASS or dispatch the paid sealed cohort until the sole owner consumes source-raster-bound box evidence, transforms cover coordinates correctly, preserves explicit authored-layout anchors and passes decoded full-range proof. |
