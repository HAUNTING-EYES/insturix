...
51. Compose the canonical-media ports, CreditsService guard, route transport,
    ...
    project authority.
52. Export authenticated routes and run the non-production QStash/Atlas
    crash/restart/redelivery exercise only after step 51 exists.
53. Only after fresh zero-inference preflight and explicit spend approval:
    resumed paid model inference.

## Evidence basis

- Repository code through `0917a6c4e` and orchestration-decision commit
  `19d8c97a8`.
