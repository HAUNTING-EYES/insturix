...
49. Compose the canonical-media ports, CreditsService guard, route transport,
    ...
    project authority.
50. Export authenticated routes and run the non-production QStash/Atlas
    crash/restart/redelivery exercise only after step 49 exists.
51. Only after fresh zero-inference preflight and explicit spend approval:
    resumed paid model inference.

## Evidence basis

- Repository code through `a8b7036f9` and orchestration-decision commit
  `19d8c97a8`.
