...
48. Compose the canonical-media ports, CreditsService guard, route transport,
    ...
    project authority.
49. Export authenticated routes and run the non-production QStash/Atlas
    crash/restart/redelivery exercise only after step 47 exists.
50. Only after fresh zero-inference preflight and explicit spend approval:
    resumed paid model inference.

## Evidence basis

- Repository code through `219c0e7ab` and orchestration-decision commit
  `19d8c97a8`.
