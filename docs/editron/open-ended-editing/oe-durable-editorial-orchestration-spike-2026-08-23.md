...
52. Compose the canonical-media ports, CreditsService guard, route transport,
    ...
    project authority.
53. Export authenticated routes and run the non-production QStash/Atlas
    crash/restart/redelivery exercise only after step 52 exists.
54. Only after fresh zero-inference preflight and explicit spend approval:
    resumed paid model inference.

## Evidence basis

- Repository code through `54273324d` and orchestration-decision commit
  `19d8c97a8`.
