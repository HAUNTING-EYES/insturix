...
53. Compose the canonical-media ports, CreditsService guard, route transport,
    ...
    project authority.
54. Export authenticated routes and run the non-production QStash/Atlas
    crash/restart/redelivery exercise only after step 53 exists.
55. Only after fresh zero-inference preflight and explicit spend approval:
    resumed paid model inference.

## Evidence basis

- Repository code through `a70a37158` and orchestration-decision commit
  `19d8c97a8`.
