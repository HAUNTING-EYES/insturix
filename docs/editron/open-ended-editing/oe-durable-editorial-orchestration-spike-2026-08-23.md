...
- connect the existing canonical reference materializer to an authorized,
  idempotent issuer for the `607212e02`/`8bf1d766e` binding and artifact-
  metadata records plus the independently decided rights/privacy policy grant;
...
- Repository code through `8bf1d766e` and orchestration-decision commit
  `19d8c97a8`.
