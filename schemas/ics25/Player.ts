...
const PlayerSchema = new Schema({
  ...
  cashbacks: {
    ...
    linkedinPost: { type: CashbackTaskSchema, default: () => ({ amount: 100, status: 'none' }) },
    referral: { type: ReferralSchema, default: () => ({ amount: 150, referredCount: 0, referredUserIds: [], qualified: false }) },
  },
  referredBy: {
    code: { type: String },
