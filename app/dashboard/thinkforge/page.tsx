...
export default function EditronDashboard() {
    return (
        <DashboardShell>
            {/* Dashboard Header */}
            <div className="mb-8 p-6 rounded-2xl bg-white/[0.02] backdrop-blur-xl border border-white/[0.08]
                        shadow-[0_0_0_1px_rgba(255,255,255,0.04)]
                        hover:shadow-[0_0_0_1px_rgba(255,255,255,0.08)]">
                <h1 className="text-3xl font-bold tracking-tight text-white/90">
                    ThinkForge Dashboard
                </h1>
                <p className="text-white/60 mt-2 text-lg font-light">Manage your ThinkForge workspace and projects</p>
            </div>            <DashboardCard.Grid>
