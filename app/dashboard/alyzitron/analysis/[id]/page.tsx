...
const analysisData: AnalysisData = {
  ...
  engagement_metrics: {
    value_proposition_clarity: {
      score: 78,
      description:
        "The video demonstrates the value of understanding financial terms in business negotiations.",
    },
    information_clarity: {
      score: 70,
      description:
        "The information is presented clearly, but could benefit from additional context and explanations.",
    },
    structure_organization: {
      score: 80,
      description:
        "The video is structured around a specific negotiation, which provides a clear narrative.",
    },
    comprehensibility: {
      score: 75,
      description:
        "The video is generally comprehensible, but some viewers may need background knowledge of business terms.",
    },
  },
  technical_quality: {
    screen_recording_quality: {
      score: 70,
      description:
        "The screen recording quality is adequate, but could be improved for better viewing on larger screens.",
    },
    voice_clarity: {
      score: 85,
      description:
        "The voice clarity is good, and the audio is easy to understand.",
    },
    visual_aids_usage: {
      score: 80,
      description:
        "The video effectively uses text overlays to highlight key information.",
    },
  },
  seo_optimization: {
    title_keyword_relevance: {
      score: 70,
      description:
        "The title is relevant but could be more optimized by including specific keywords related to negotiation and Shark Tank.",
    },
    description_richness_clarity: {
      score: 65,
      description:
        "The description could be improved by adding more relevant keywords and a call to action.",
    },
    content_categorization_accuracy: {
      description:
        "The video is accurately categorized as business and finance education content.",
    },
  },
  creator_feedback: {
    strengths: [
  ...
  compliance_risks: {
    copyright_risk: {
      score: 65,
      description:
        "The video appears to use clips from Shark Tank, which may pose a copyright risk depending on the permissions and context of use. Need to ensure fair use or obtain necessary licenses.",
    },
    guidelines_compliance: {
      score: 85,
      description:
        "The video does not appear to violate YouTube's community guidelines. The content is related to business and investment, and there is no explicit sexual content, promotion of harmful activities, or hateful content.",
    },
    social_risk: {
      score: 75,
      description:
        "The video is unlikely to cause significant social backlash. While it involves negotiations and financial decisions, the tone remains professional and respectful. There are no apparent controversial topics or offensive stereotypes.",
    },
  },
};
    ...
    <div className="container mx-auto p-8 space-y-8">
      ...
      <div className="flex items-end justify-between pb-8 mb-8 border-b border-zinc-800">
        <div>
          ...
          <p className="text-zinc-400 mt-2">
            Educational Video • March 16, 2024
          </p>
        </div>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
        {Object.entries(analysisData).map(([section, data]) => {
          ...
          if (section === "creator_feedback" || section === "category")
            return null;
              ...
              <CardContent className="space-y-4">
                {Object.entries(data as Record<string, MetricData>).map(
                  ([key, value]) => (
                    <div
                      key={key}
                      className="p-5 bg-black/20 rounded-lg hover:bg-black/30 transition-colors"
                    >
