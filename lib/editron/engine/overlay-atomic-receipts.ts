...
function contentSignalsFromSignals(signals: Record<string, unknown>): Partial<ContentSignals> {
  return compactRecord({
    ...
    enthusiasm: signalNumber(signals, "enthusiasm", "emotion.enthusiasm", "personality.enthusiasm"),
    warmth: signalNumber(signals, "warmth", "emotion.warmth", "personality.warmth"),
    emotional_arousal: signalNumber(signals, "emotional_arousal", "personality.emotional_arousal", "emotion_arousal", "emotion.arousal"),
    pacing_velocity: signalNumber(signals, "pacing_velocity", "rhythm_density", "rhythm.density", "personality.pacing_velocity"),
    humor: signalNumber(signals, "humor"),
    visceral_impact: signalNumber(signals, "visceral_impact", "personality.visceral_impact", "impact.visceral"),
    visual_dependency: signalNumber(signals, "visual_dependency", "text_coverage", "visual.text_coverage", "visual_text_coverage"),
    emotion_intensity: signalNumber(signals, "emotion_intensity", "speech.emotion_intensity", "speech.emotional_valence", "emotional_valence"),
    pitch_variability: signalNumber(signals, "pitch_variability", "speech.pitch_variability", "speech.pitch_contour", "pitch_contour"),
