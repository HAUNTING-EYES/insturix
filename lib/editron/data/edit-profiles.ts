...
const A01: EditProfile = {
  ...
  category: 'platform-native', filterPresetId: 'warm-neutral', pacing: 'medium',
...
const A02: EditProfile = {
  ...
  category: 'platform-native', filterPresetId: 'vivid', pacing: 'fast',
...
const A04: EditProfile = {
  ...
  category: 'platform-native', filterPresetId: 'clean-corporate', pacing: 'medium',
...
const A05: EditProfile = {
  ...
  category: 'platform-native', filterPresetId: 'warm-neutral', pacing: 'fast',
...
const A07: EditProfile = {
  ...
  category: 'platform-native', filterPresetId: 'golden-hour-pro', pacing: 'slow',
...
const A08: EditProfile = {
  ...
  category: 'platform-native', filterPresetId: 'teal-orange', pacing: 'variable',
...
const B01: EditProfile = {
  ...
  category: 'industry-vertical', filterPresetId: 'clean-corporate', pacing: 'medium',
...
const B02: EditProfile = {
  ...
  category: 'industry-vertical', filterPresetId: 'teal-orange', pacing: 'medium',
...
const B03: EditProfile = {
  ...
  category: 'industry-vertical', filterPresetId: 'desaturated-drama', pacing: 'beat-synced',
...
const B04: EditProfile = {
  ...
  category: 'industry-vertical', filterPresetId: 'golden-hour-pro', pacing: 'medium',
  cutsPerMinRange: [8, 16], defaultTransition: 'soft-cut', captionStyle: 'tiktok', bgmDuckLevel: 0.20,
  graphicsDensity: 'moderate',
  actions: [applyFilter('golden-hour-pro'), addTransition('soft-cut'), addCaptions('tiktok'), audioDuck(0.20), qualityReview()],
  signalKeywords: [
...
const B05: EditProfile = {
  ...
  category: 'industry-vertical', filterPresetId: 'vivid', pacing: 'fast',
...
const B06: EditProfile = {
  ...
  category: 'industry-vertical', filterPresetId: 'clean-corporate', pacing: 'slow',
...
const B07: EditProfile = {
  ...
  category: 'industry-vertical', filterPresetId: 'blade-runner', pacing: 'medium',
...
const B10: EditProfile = {
  ...
  category: 'industry-vertical', filterPresetId: 'warm-neutral', pacing: 'medium',
...
const B12: EditProfile = {
  ...
  category: 'industry-vertical', filterPresetId: 'film-portra', pacing: 'slow',
...
const B13: EditProfile = {
  ...
  category: 'industry-vertical', filterPresetId: 'neon-nights', pacing: 'fast',
...
const B14: EditProfile = {
  ...
  category: 'industry-vertical', filterPresetId: 'film-portra', pacing: 'medium',
...
const C01: EditProfile = { profileId: 'C-01', name: 'Talking Head / Interview', description: 'On-camera speaking, B-roll covers', category: 'content-format', filterPresetId: 'warm-neutral', pacing: 'medium', cutsPerMinRange: [6, 12], defaultTransition: 'hard-cut', captionStyle: 'subtitle', bgmDuckLevel: 0.05, graphicsDensity: 'moderate', actions: [applyFilter('warm-neutral'), addTransition('hard-cut'), addCaptions('subtitle'), lowerThird(), audioDuck(0.05), qualityReview()], signalKeywords: [{ term: 'presenter', field: 'visual', weight: 0.3 }, { term: 'interview', field: 'visual', weight: 0.4 }, { term: 'talking', field: 'visual', weight: 0.3 }, { term: 'studio', field: 'environment', weight: 0.2 }] };

const C02: EditProfile = { profileId: 'C-02', name: 'Tutorial / How-To', description: 'Step-by-step instruction', category: 'content-format', filterPresetId: 'clean-corporate', pacing: 'medium', cutsPerMinRange: [8, 14], defaultTransition: 'dip-to-black', captionStyle: 'word-by-word', bgmDuckLevel: 0.20, graphicsDensity: 'heavy', actions: [applyFilter('clean-corporate'), addTransition('dip-to-black'), addCaptions('word-by-word'), audioDuck(0.20), qualityReview()], signalKeywords: [{ term: 'step 1', field: 'narration', weight: 0.3 }, { term: 'how to', field: 'narration', weight: 0.3 }, { term: 'tutorial', field: 'contentType', weight: 0.45 }, { term: 'demonstration', field: 'visual', weight: 0.2 }] };

const C03: EditProfile = { profileId: 'C-03', name: 'Documentary / Mini-Doc', description: 'Reality-grounded storytelling', category: 'content-format', filterPresetId: 'muted-doc', pacing: 'slow', cutsPerMinRange: [5, 12], defaultTransition: 'hard-cut', captionStyle: 'subtitle', bgmDuckLevel: 0.22, graphicsDensity: 'minimal', actions: [applyFilter('muted-doc'), addTransition('hard-cut'), addCaptions('subtitle'), lowerThird(), audioDuck(0.22), qualityReview(true)], signalKeywords: [{ term: 'documentary', field: 'contentType', weight: 0.5 }, { term: 'authentic', field: 'mood', weight: 0.2 }, { term: 'observational', field: 'mood', weight: 0.3 }] };

const C04: EditProfile = { profileId: 'C-04', name: 'Explainer / Animated', description: 'Concept communication with visual aids', category: 'content-format', filterPresetId: 'vivid', pacing: 'medium', cutsPerMinRange: [10, 18], defaultTransition: 'hard-cut', captionStyle: 'keyword-highlight', bgmDuckLevel: 0.18, graphicsDensity: 'heavy', actions: [applyFilter('vivid'), addTransition('hard-cut'), addCaptions('keyword-highlight'), audioDuck(0.18), qualityReview()], signalKeywords: [{ term: 'explainer', field: 'contentType', weight: 0.45 }, { term: 'diagram', field: 'visual', weight: 0.3 }, { term: 'think of it as', field: 'narration', weight: 0.2 }] };

const C05: EditProfile = { profileId: 'C-05', name: 'Testimonial / Social Proof', description: 'Customer speaks, authenticity is value', category: 'content-format', filterPresetId: 'film-portra', pacing: 'slow', cutsPerMinRange: [5, 10], defaultTransition: 'dip-to-black', captionStyle: 'subtitle', bgmDuckLevel: 0.05, graphicsDensity: 'minimal', actions: [applyFilter('film-portra'), addTransition('dip-to-black'), addCaptions('subtitle'), lowerThird(), audioDuck(0.05), qualityReview()], signalKeywords: [{ term: 'customer', field: 'character', weight: 0.3 }, { term: 'client', field: 'character', weight: 0.3 }, { term: 'testimonial', field: 'contentType', weight: 0.45 }] };

const C06: EditProfile = { profileId: 'C-06', name: 'Event Highlight Reel', description: 'Conference, launch, concert coverage', category: 'content-format', filterPresetId: 'vivid', pacing: 'fast', cutsPerMinRange: [15, 25], defaultTransition: 'whip-pan', captionStyle: 'none', bgmDuckLevel: 0.15, graphicsDensity: 'moderate', actions: [applyFilter('vivid'), addTransition('whip-pan'), beatSync('downbeats', 0.6, 3), audioDuck(0.15), qualityReview()], signalKeywords: [{ term: 'event', field: 'visual', weight: 0.3 }, { term: 'keynote', field: 'visual', weight: 0.3 }, { term: 'conference', field: 'environment', weight: 0.3 }] };

const C07: EditProfile = { profileId: 'C-07', name: 'Keynote / Presentation', description: 'Speaker-forward with slide support', category: 'content-format', filterPresetId: 'clean-corporate', pacing: 'medium', cutsPerMinRange: [5, 10], defaultTransition: 'hard-cut', captionStyle: 'subtitle', bgmDuckLevel: 0.05, graphicsDensity: 'moderate', actions: [applyFilter('clean-corporate'), addTransition('hard-cut'), addCaptions('subtitle'), lowerThird(), audioDuck(0.05), qualityReview()], signalKeywords: [{ term: 'speaker', field: 'character', weight: 0.3 }, { term: 'stage', field: 'environment', weight: 0.3 }, { term: 'conference', field: 'environment', weight: 0.3 }] };

const C08: EditProfile = { profileId: 'C-08', name: 'Vlog / Day-in-Life', description: 'Creator personality content', category: 'content-format', filterPresetId: 'golden-hour-pro', pacing: 'medium', cutsPerMinRange: [12, 20], defaultTransition: 'hard-cut', captionStyle: 'fancy', bgmDuckLevel: 0.20, graphicsDensity: 'moderate', actions: [applyFilter('golden-hour-pro'), addTransition('hard-cut'), addFancyCaptions('creator'), audioDuck(0.20), qualityReview()], signalKeywords: [{ term: 'today', field: 'narration', weight: 0.2 }, { term: 'vlog', field: 'contentType', weight: 0.4 }, { term: 'lo-fi', field: 'music', weight: 0.2 }] };

const C09: EditProfile = { profileId: 'C-09', name: 'Podcast / Audio Clip', description: 'Audio-primary with visual accompaniment', category: 'content-format', filterPresetId: 'clean-corporate', pacing: 'medium', cutsPerMinRange: [4, 8], defaultTransition: 'hard-cut', captionStyle: 'subtitle', bgmDuckLevel: 0.05, graphicsDensity: 'moderate', actions: [applyFilter('clean-corporate'), addTransition('hard-cut'), addCaptions('subtitle'), lowerThird(), audioDuck(0.05), qualityReview()], signalKeywords: [{ term: 'podcast', field: 'contentType', weight: 0.45 }, { term: 'hosts', field: 'character', weight: 0.2 }, { term: 'guests', field: 'character', weight: 0.2 }] };

const C10: EditProfile = { profileId: 'C-10', name: 'Music Video', description: 'Rhythm-locked, performance + narrative', category: 'content-format', filterPresetId: 'teal-orange', pacing: 'beat-synced', cutsPerMinRange: [20, 40], defaultTransition: 'hard-cut', captionStyle: 'none', bgmDuckLevel: 0.90, graphicsDensity: 'minimal', actions: [applyFilter('teal-orange'), addTransition('hard-cut'), beatSync('all', 0.4, 3), qualityReview()], signalKeywords: [{ term: 'music video', field: 'contentType', weight: 0.5 }, { term: 'performance', field: 'visual', weight: 0.3 }] };

const C11: EditProfile = { profileId: 'C-11', name: 'Training / Corporate Onboarding', description: 'Process compliance, accessibility required', category: 'content-format', filterPresetId: 'clean-corporate', pacing: 'medium', cutsPerMinRange: [6, 12], defaultTransition: 'dip-to-black', captionStyle: 'subtitle', bgmDuckLevel: 0.20, graphicsDensity: 'moderate', actions: [applyFilter('clean-corporate'), addTransition('dip-to-black'), addCaptions('subtitle'), audioDuck(0.20), qualityReview()], signalKeywords: [{ term: 'training', field: 'contentType', weight: 0.45 }, { term: 'onboarding', field: 'contentType', weight: 0.4 }, { term: 'policy', field: 'narration', weight: 0.2 }, { term: 'compliance', field: 'narration', weight: 0.3 }] };

const C12: EditProfile = { profileId: 'C-12', name: 'Recruitment / Culture Video', description: 'Employer brand, attract talent', category: 'content-format', filterPresetId: 'golden-hour-pro', pacing: 'medium', cutsPerMinRange: [10, 16], defaultTransition: 'dissolve', captionStyle: 'subtitle', bgmDuckLevel: 0.20, graphicsDensity: 'moderate', actions: [applyFilter('golden-hour-pro'), addTransition('dissolve'), addCaptions('subtitle'), lowerThird(), audioDuck(0.20), qualityReview()], signalKeywords: [{ term: 'team', field: 'narration', weight: 0.2 }, { term: 'culture', field: 'narration', weight: 0.3 }, { term: 'join us', field: 'narration', weight: 0.3 }, { term: 'recruitment', field: 'contentType', weight: 0.4 }] };

// ═══════════════════════════════════════════════════════════════════
// CATEGORY D — CINEMATIC STYLE (8 profiles)
// ═══════════════════════════════════════════════════════════════════

const D01: EditProfile = { profileId: 'D-01', name: 'Cinematic Premium', description: 'Film-quality brand films, every frame intentional', category: 'cinematic-style', filterPresetId: 'teal-orange', pacing: 'slow', cutsPerMinRange: [4, 8], defaultTransition: 'dip-to-black', captionStyle: 'none', bgmDuckLevel: 0.18, graphicsDensity: 'minimal', transitionSFXPolicy: 'subtle', actions: [applyFilter('teal-orange'), addTransition('dip-to-black'), audioDuck(0.18), qualityReview(true)], signalKeywords: [{ term: 'orchestral', field: 'music', weight: 0.4 }, { term: 'cinematic', field: 'notes', weight: 0.5 }, { term: 'premium', field: 'notes', weight: 0.3 }, { term: 'film', field: 'notes', weight: 0.3 }] };

const D02: EditProfile = { profileId: 'D-02', name: 'Documentary Verite', description: 'Raw, observational, truth-feeling', category: 'cinematic-style', filterPresetId: 'muted-doc', pacing: 'slow', cutsPerMinRange: [5, 10], defaultTransition: 'hard-cut', captionStyle: 'subtitle', bgmDuckLevel: 0.25, graphicsDensity: 'minimal', transitionSFXPolicy: 'off', actions: [applyFilter('muted-doc'), addTransition('hard-cut'), addCaptions('subtitle'), lowerThird(), audioDuck(0.25), qualityReview()], signalKeywords: [{ term: 'verite', field: 'notes', weight: 0.5 }, { term: 'observational', field: 'notes', weight: 0.4 }, { term: 'raw', field: 'notes', weight: 0.2 }, { term: 'authentic', field: 'notes', weight: 0.3 }] };

const D03: EditProfile = { profileId: 'D-03', name: 'Bold / High Energy', description: 'Maximum visual impact, sensory overload strategy', category: 'cinematic-style', filterPresetId: 'vivid', pacing: 'fast', cutsPerMinRange: [30, 50], defaultTransition: 'zoom-punch', captionStyle: 'fancy', bgmDuckLevel: 0.10, graphicsDensity: 'heavy', actions: [applyFilter('vivid'), addTransition('zoom-punch'), addFancyCaptions('kinetic'), beatSync('all', 0.4, 3), audioDuck(0.10), qualityReview()], signalKeywords: [{ term: 'bold', field: 'notes', weight: 0.4 }, { term: 'energetic', field: 'notes', weight: 0.3 }, { term: 'viral', field: 'notes', weight: 0.3 }, { term: 'trap', field: 'music', weight: 0.3 }] };

const D04: EditProfile = { profileId: 'D-04', name: 'Minimalist / Clean', description: 'Less is more, typography-forward', category: 'cinematic-style', filterPresetId: 'clean-corporate', pacing: 'slow', cutsPerMinRange: [5, 8], defaultTransition: 'hard-cut', captionStyle: 'none', bgmDuckLevel: 0.20, graphicsDensity: 'minimal', actions: [applyFilter('clean-corporate'), addTransition('hard-cut'), audioDuck(0.20), qualityReview()], signalKeywords: [{ term: 'minimal', field: 'notes', weight: 0.5 }, { term: 'clean', field: 'notes', weight: 0.3 }, { term: 'simple', field: 'notes', weight: 0.3 }, { term: 'white space', field: 'notes', weight: 0.4 }] };

const D05: EditProfile = { profileId: 'D-05', name: 'Retro / Vintage', description: 'Nostalgic aesthetic, film grain, analog imperfections', category: 'cinematic-style', filterPresetId: 'retro', pacing: 'medium', cutsPerMinRange: [6, 12], defaultTransition: 'dissolve', captionStyle: 'subtitle', bgmDuckLevel: 0.20, graphicsDensity: 'moderate', transitionSFXPolicy: 'subtle', actions: [applyFilter('retro'), addTransition('dissolve'), addCaptions('subtitle'), audioDuck(0.20), qualityReview()], signalKeywords: [{ term: 'retro', field: 'notes', weight: 0.5 }, { term: 'vintage', field: 'notes', weight: 0.5 }, { term: 'nostalgic', field: 'notes', weight: 0.4 }, { term: 'vinyl', field: 'music', weight: 0.3 }] };

const D06: EditProfile = { profileId: 'D-06', name: 'Dark / Moody Thriller', description: 'Tension, mystery, psychological weight', category: 'cinematic-style', filterPresetId: 'desaturated-drama', pacing: 'slow', cutsPerMinRange: [4, 8], defaultTransition: 'hard-cut', captionStyle: 'none', bgmDuckLevel: 0.12, graphicsDensity: 'minimal', actions: [applyFilter('desaturated-drama'), addTransition('hard-cut'), audioDuck(0.12), qualityReview()], signalKeywords: [{ term: 'dark', field: 'notes', weight: 0.4 }, { term: 'thriller', field: 'notes', weight: 0.5 }, { term: 'tension', field: 'notes', weight: 0.3 }, { term: 'ominous', field: 'music', weight: 0.3 }] };

const D07: EditProfile = { profileId: 'D-07', name: 'Warm / Emotional Story', description: 'Human connection, golden warmth, held moments', category: 'cinematic-style', filterPresetId: 'film-portra', pacing: 'slow', cutsPerMinRange: [5, 10], defaultTransition: 'dissolve', captionStyle: 'subtitle', bgmDuckLevel: 0.22, graphicsDensity: 'minimal', transitionSFXPolicy: 'subtle', actions: [applyFilter('film-portra'), addTransition('dissolve'), addCaptions('subtitle'), audioDuck(0.22), qualityReview()], signalKeywords: [{ term: 'emotional', field: 'music', weight: 0.4 }, { term: 'heartfelt', field: 'notes', weight: 0.4 }, { term: 'piano', field: 'music', weight: 0.3 }, { term: 'strings', field: 'music', weight: 0.3 }] };

const D08: EditProfile = { profileId: 'D-08', name: 'Luxury / Editorial', description: 'Premium restraint, zero clutter, confidence through pace', category: 'cinematic-style', filterPresetId: 'teal-orange', pacing: 'slow', cutsPerMinRange: [3, 6], defaultTransition: 'dip-to-black', captionStyle: 'none', bgmDuckLevel: 0.15, graphicsDensity: 'minimal', transitionSFXPolicy: 'off', actions: [applyFilter('teal-orange'), addTransition('dip-to-black'), audioDuck(0.15), qualityReview(true)], signalKeywords: [{ term: 'luxury', field: 'notes', weight: 0.5 }, { term: 'premium', field: 'notes', weight: 0.4 }, { term: 'editorial', field: 'notes', weight: 0.4 }, { term: 'sophisticated', field: 'notes', weight: 0.3 }, { term: 'jazz', field: 'music', weight: 0.3 }] };

// ═══════════════════════════════════════════════════════════════════
// CATEGORY E — NARRATIVE MODE (6 profiles)
// ═══════════════════════════════════════════════════════════════════

const E01: EditProfile = { profileId: 'E-01', name: 'Problem → Solution (AIDA)', description: 'Pain → amplify → solve → prove → CTA', category: 'narrative-mode', filterPresetId: 'warm-neutral', pacing: 'variable', cutsPerMinRange: [10, 18], defaultTransition: 'dip-to-black', captionStyle: 'subtitle', bgmDuckLevel: 0.20, graphicsDensity: 'moderate', actions: [applyFilter('warm-neutral'), addTransition('dip-to-black'), addCaptions('subtitle'), audioDuck(0.20), qualityReview()], signalKeywords: [{ term: 'problem', field: 'narration', weight: 0.2 }, { term: 'solution', field: 'narration', weight: 0.2 }, { term: 'ad', field: 'contentType', weight: 0.3 }, { term: 'marketing', field: 'contentType', weight: 0.3 }] };

const E02: EditProfile = { profileId: 'E-02', name: 'Before → After Transformation', description: 'Felt before, transformation peak, aspirational after', category: 'narrative-mode', filterPresetId: 'vivid', pacing: 'variable', cutsPerMinRange: [8, 16], defaultTransition: 'zoom-punch', captionStyle: 'subtitle', bgmDuckLevel: 0.20, graphicsDensity: 'moderate', actions: [applyFilter('vivid'), addTransition('zoom-punch'), addCaptions('subtitle'), audioDuck(0.20), qualityReview()], signalKeywords: [{ term: 'before', field: 'narration', weight: 0.3 }, { term: 'after', field: 'narration', weight: 0.3 }, { term: 'transformation', field: 'narration', weight: 0.4 }, { term: 'results', field: 'narration', weight: 0.2 }] };

const E03: EditProfile = { profileId: 'E-03', name: 'Data-Driven / Evidence', description: 'Numbers tell the story, charts build live', category: 'narrative-mode', filterPresetId: 'clean-corporate', pacing: 'medium', cutsPerMinRange: [8, 14], defaultTransition: 'hard-cut', captionStyle: 'subtitle', bgmDuckLevel: 0.20, graphicsDensity: 'heavy', actions: [applyFilter('clean-corporate'), addTransition('hard-cut'), addCaptions('subtitle'), audioDuck(0.20), qualityReview()], signalKeywords: [{ term: 'data', field: 'narration', weight: 0.3 }, { term: 'statistics', field: 'narration', weight: 0.3 }, { term: 'percentage', field: 'narration', weight: 0.2 }, { term: 'chart', field: 'visual', weight: 0.3 }] };
...
const E05: EditProfile = { profileId: 'E-05', name: 'Expert Authority Build', description: 'Credentials → evidence → demonstration → social proof', category: 'narrative-mode', filterPresetId: 'clean-corporate', pacing: 'medium', cutsPerMinRange: [8, 14], defaultTransition: 'hard-cut', captionStyle: 'subtitle', bgmDuckLevel: 0.20, graphicsDensity: 'moderate', actions: [applyFilter('clean-corporate'), addTransition('hard-cut'), addCaptions('subtitle'), lowerThird(), audioDuck(0.20), qualityReview()], signalKeywords: [{ term: 'expert', field: 'character', weight: 0.3 }, { term: 'results show', field: 'narration', weight: 0.3 }, { term: 'data proves', field: 'narration', weight: 0.3 }] };

const E06: EditProfile = { profileId: 'E-06', name: 'Comedy / Entertainment', description: 'Punchline is the edit, timing IS the joke', category: 'narrative-mode', filterPresetId: 'vivid', pacing: 'variable', cutsPerMinRange: [12, 25], defaultTransition: 'hard-cut', captionStyle: 'subtitle', bgmDuckLevel: 0.15, graphicsDensity: 'moderate', actions: [applyFilter('vivid'), addTransition('hard-cut'), addCaptions('subtitle'), audioDuck(0.15), qualityReview()], signalKeywords: [{ term: 'funny', field: 'mood', weight: 0.4 }, { term: 'comedy', field: 'contentType', weight: 0.45 }, { term: 'satirical', field: 'mood', weight: 0.3 }] };

// ═══════════════════════════════════════════════════════════════════
// CATEGORY F — PRODUCTION MODE (4 profiles)
// ═══════════════════════════════════════════════════════════════════

const F01: EditProfile = { profileId: 'F-01', name: 'Full AI Generated', description: 'All scenes AI-generated via ThinkForge. Anti-slop mandatory.', category: 'production-mode', filterPresetId: 'cinematic', pacing: 'medium', cutsPerMinRange: [8, 15], defaultTransition: 'soft-cut', captionStyle: 'subtitle', bgmDuckLevel: 0.20, graphicsDensity: 'moderate', actions: [applyFilter('cinematic'), addTransition('soft-cut'), addCaptions('subtitle'), audioDuck(0.20), qualityReview(true)], signalKeywords: [{ term: 'AI-generated', field: 'contentType', weight: 0.5 }] };

const F02: EditProfile = { profileId: 'F-02', name: 'Real Footage + Script', description: 'Shot footage against ThinkForge script, transcription-aligned', category: 'production-mode', filterPresetId: 'cinematic', pacing: 'medium', cutsPerMinRange: [8, 15], defaultTransition: 'hard-cut', captionStyle: 'subtitle', bgmDuckLevel: 0.20, graphicsDensity: 'moderate', actions: [applyFilter('cinematic'), addTransition('hard-cut'), addCaptions('subtitle'), audioDuck(0.20), qualityReview()], signalKeywords: [{ term: 'real footage', field: 'contentType', weight: 0.4 }] };

const F03: EditProfile = { profileId: 'F-03', name: 'Screen Recording / Software Demo', description: 'UI recording with annotations and step-by-step graphics', category: 'production-mode', filterPresetId: 'clean-corporate', pacing: 'medium', cutsPerMinRange: [8, 14], defaultTransition: 'hard-cut', captionStyle: 'word-by-word', bgmDuckLevel: 0.18, graphicsDensity: 'heavy', actions: [applyFilter('clean-corporate'), addTransition('hard-cut'), addCaptions('word-by-word'), audioDuck(0.18), qualityReview()], signalKeywords: [{ term: 'screen', field: 'visual', weight: 0.5 }, { term: 'UI', field: 'visual', weight: 0.4 }, { term: 'click', field: 'visual', weight: 0.3 }, { term: 'software', field: 'visual', weight: 0.3 }] };

const F04: EditProfile = { profileId: 'F-04', name: 'Hybrid (AI + Real Footage)', description: 'Mixed AI and real footage, consistency bridging mandatory', category: 'production-mode', filterPresetId: 'cinematic', pacing: 'medium', cutsPerMinRange: [8, 15], defaultTransition: 'dip-to-black', captionStyle: 'subtitle', bgmDuckLevel: 0.20, graphicsDensity: 'moderate', actions: [applyFilter('cinematic'), addTransition('dip-to-black'), addCaptions('subtitle'), audioDuck(0.20), qualityReview(true)], signalKeywords: [] };

// ═══════════════════════════════════════════════════════════════════
// CATEGORY G — SPECIAL PURPOSE (2 profiles)
// ═══════════════════════════════════════════════════════════════════

const G01: EditProfile = { profileId: 'G-01', name: 'Universal Clean (Fallback)', description: 'Applied when detection confidence < 0.40. Clean, professional, safe.', category: 'special-purpose', filterPresetId: 'clean-corporate', pacing: 'medium', cutsPerMinRange: [10, 15], defaultTransition: 'hard-cut', captionStyle: 'subtitle', bgmDuckLevel: 0.20, graphicsDensity: 'moderate', actions: [applyFilter('clean-corporate'), addTransition('hard-cut'), addCaptions('subtitle'), lowerThird(), beatSync('downbeats', 0.7, 3), audioDuck(0.20), qualityReview()], signalKeywords: [] };

const G02: EditProfile = { profileId: 'G-02', name: 'Style Blend (Two-Profile Merge)', description: 'User specifies two profiles to blend at a given ratio', category: 'special-purpose', filterPresetId: 'cinematic', pacing: 'medium', cutsPerMinRange: [8, 15], defaultTransition: 'hard-cut', captionStyle: 'subtitle', bgmDuckLevel: 0.20, graphicsDensity: 'moderate', actions: [qualityReview()], signalKeywords: [] };
