...
const D01: EditProfile = { profileId: 'D-01', name: 'Cinematic Premium', description: 'Film-quality brand films, every frame intentional', category: 'cinematic-style', filterPresetId: 'teal-orange', pacing: 'slow', pacingMultiplier: 1.40, cutsPerMinRange: [4, 8], defaultTransition: 'dip-to-black', captionStyle: 'none', bgmDuckLevel: 0.18, graphicsDensity: 'minimal', transitionSFXPolicy: 'subtle', actions: [applyFilter('teal-orange'), addTransition('dip-to-black'), audioDuck(0.18), qualityReview(true)], signalKeywords: [{ term: 'orchestral', field: 'music', weight: 0.4 }, { term: 'cinematic', field: 'notes', weight: 0.5 }, { term: 'premium', field: 'notes', weight: 0.3 }, { term: 'film', field: 'notes', weight: 0.3 }] };

const D02: EditProfile = { profileId: 'D-02', name: 'Documentary Verite', description: 'Raw, observational, truth-feeling', category: 'cinematic-style', filterPresetId: 'muted-doc', pacing: 'slow', pacingMultiplier: 1.2, cutsPerMinRange: [5, 10], defaultTransition: 'hard-cut', captionStyle: 'subtitle', bgmDuckLevel: 0.25, graphicsDensity: 'minimal', transitionSFXPolicy: 'off', actions: [applyFilter('muted-doc'), addTransition('hard-cut'), addCaptions('subtitle'), lowerThird(), audioDuck(0.25), qualityReview()], signalKeywords: [{ term: 'verite', field: 'notes', weight: 0.5 }, { term: 'observational', field: 'notes', weight: 0.4 }, { term: 'raw', field: 'notes', weight: 0.2 }, { term: 'authentic', field: 'notes', weight: 0.3 }] };
