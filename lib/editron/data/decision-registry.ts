...
export const DECISION_REGISTRY: DecisionRegistryEntry[] = [
...

  {
    ...
    defaultParams: { text: '', endValue: 0, label: '' },
    requiredParams: ['text', 'endValue', 'label'],
    minGapSec: 15,
    promptHint: 'Only for impactful numbers the viewer should remember. "73% of users" yes, "2 or 3 things" no.',
  },
  {
    ...
    description: 'Display a name, title, or label',
    defaultParams: { text: '' },
    requiredParams: ['text'],
    minGapSec: 20,
    promptHint: 'Names of people, places, products being introduced. First mention only.',
  },
  {
    id: 'graphic-callout',
    ...
    budgetCategory: 'graphic',
    signal: 'emphasis_word',
    description: 'Callout box highlighting a key concept',
    defaultParams: { text: '' },
    requiredParams: ['text'],
    minGapSec: 20,
    promptHint: 'Key concepts that deserve visual reinforcement. Use sparingly.',
  },
  {
    ...
    requiredParams: ['text'],
    minGapSec: 10,
    promptHint: 'Quick keyword pop. Lighter than callout. For terms worth remembering.',
  },
  {
