...
export const THRESHOLD_REGISTRY: ThresholdEntry[] = [
  ...
  // Procedural pattern constants — design defaults, not bandit-tunable.
  // ═══════════════════════════════════════════════════════════════════════════

  {
    ...
    source: 'invented',
    sourceRef: 'No CRG or creative doc covers procedural pattern generation',
    prior: { mu: 28, sigma: 0 },
    adaptive: false,
  },
  {
...

  {
    ...
    source: 'invented',
    sourceRef: 'No CRG or creative doc covers chart specs',
    prior: { mu: 8, sigma: 0 },
    adaptive: false,
  },
  {
...

  {
    ...
    source: 'invented',
    sourceRef: 'No CRG or creative doc covers brand corner radius defaults',
    prior: { mu: 8, sigma: 2 },
    adaptive: true,
  },
  {
    ...
    source: 'invented',
    sourceRef: 'No CRG or creative doc covers radius-from-font derivation',
