...
export const THRESHOLD_REGISTRY: ThresholdEntry[] = [
  ...
  },
  {
    ...
    source: 'domain',
    sourceRef: 'Current service default BATCH_SIZE=20. System limit, not creative threshold.',
    prior: { mu: 20, sigma: 0 },
    adaptive: false,
    fixed: true,
  },
  {
    id: 'vjepa-frame-sample-count',
    file: 'services/vjepa-service.ts',
    value: 32,
    unit: 'frames/segment',
    controls: 'Adaptive V-JEPA frame sample cap: 64 under 80 segments, 48 at 80+, 32 at 160+, 24 at 220+; env override clamps 8-64.',
    source: 'invented',
    sourceRef: 'INVENTED-needs-calibration. Based on 2026-06 telemetry where 180-236 segment V-JEPA runs approached or hit the 600s Modal ceiling.',
    prior: { mu: 32, sigma: 12 },
    adaptive: true,
  },
  {
  ...
  // ═══════════════════════════════════════════════════════════════════════════
  // BRAND PATTERN GENERATOR (brand-pattern-generator.ts)
  // Design convention constants. Not CRG-covered, but grounded in standard
  // SVG/CSS pattern practices and brand identity systems.
  // ═══════════════════════════════════════════════════════════════════════════

  {
    id: 'brand-dot-spacing',
    file: 'motion-graphics/engine/brand-pattern-generator.ts',
    value: 28,
    unit: 'px',
    controls: 'Dot pattern spacing (standard density)',
    source: 'domain',
    sourceRef: 'SVG/CSS pattern convention — standard dot/grid spacing in brand identity systems.',
    prior: { mu: 28, sigma: 0 },
    adaptive: false,
  },
  {
    ...
    value: 1.5,
    unit: 'px',
    controls: 'Dot pattern dot radius (standard density)',
    source: 'domain',
    sourceRef: 'SVG/CSS pattern convention — standard dot/grid spacing in brand identity systems.',
    prior: { mu: 1.5, sigma: 0 },
    adaptive: false,
  },
  {
    id: 'brand-dot-opacity',
    file: 'motion-graphics/engine/brand-pattern-generator.ts',
    value: 0.06,
    unit: 'ratio',
    controls: 'Dot pattern opacity (standard density)',
    source: 'domain',
    sourceRef: 'SVG/CSS pattern convention — standard dot/grid spacing in brand identity systems.',
    prior: { mu: 0.06, sigma: 0 },
    adaptive: false,
  },
  {
    id: 'brand-grid-spacing',
    file: 'motion-graphics/engine/brand-pattern-generator.ts',
    value: 36,
    unit: 'px',
    controls: 'Grid pattern line spacing (standard density)',
    source: 'domain',
    sourceRef: 'SVG/CSS pattern convention — standard dot/grid spacing in brand identity systems.',
    prior: { mu: 36, sigma: 0 },
    adaptive: false,
  ...
  {
    id: 'brand-grid-opacity',
    file: 'motion-graphics/engine/brand-pattern-generator.ts',
    value: 0.06,
    unit: 'ratio',
    controls: 'Grid pattern line opacity',
    source: 'domain',
    sourceRef: 'SVG/CSS pattern convention — standard dot/grid spacing in brand identity systems.',
    prior: { mu: 0.06, sigma: 0 },
    adaptive: false,
  ...
  {
    id: 'brand-gradient-angle',
    file: 'motion-graphics/engine/brand-pattern-generator.ts',
    value: 135,
    unit: 'degrees',
    controls: 'Gradient pattern angle',
    source: 'domain',
    sourceRef: 'SVG/CSS pattern convention — standard dot/grid spacing in brand identity systems.',
    prior: { mu: 135, sigma: 0 },
    adaptive: false,
  },
  {
    id: 'brand-gradient-opacity',
    file: 'motion-graphics/engine/brand-pattern-generator.ts',
    value: 0.08,
    unit: 'ratio',
    controls: 'Gradient pattern opacity',
    source: 'domain',
    sourceRef: 'SVG/CSS pattern convention — standard dot/grid spacing in brand identity systems.',
    prior: { mu: 0.08, sigma: 0 },
    adaptive: false,
  },

  // ═══════════════════════════════════════════════════════════════════════════
  // DATA VISUALIZATION RENDERERS (data-viz-renderers.tsx)
  // Chart/graph rendering constants — not bandit-tunable.
  // ═══════════════════════════════════════════════════════════════════════════

  {
    id: 'dataviz-bar-max-count',
    file: 'motion-graphics/engine/data-viz-renderers.tsx',
    value: 8,
    unit: 'count',
    controls: 'Max bars in a bar chart before clipping',
    source: 'domain',
    sourceRef: 'Data visualization convention — readability at video resolution (Tufte, broadcast standards).',
    prior: { mu: 8, sigma: 0 },
    adaptive: false,
  },
  {
    ...
    value: 4,
    unit: 'px',
    controls: 'Gap between bars in bar chart',
    source: 'domain',
    sourceRef: 'Data visualization convention — readability at video resolution (Tufte, broadcast standards).',
    prior: { mu: 4, sigma: 0 },
    adaptive: false,
  ...
  {
    id: 'dataviz-bar-label-width',
    file: 'motion-graphics/engine/data-viz-renderers.tsx',
    value: 0.25,
    unit: 'ratio',
    controls: 'Label column width as fraction of bar chart width',
    source: 'domain',
    sourceRef: 'Data visualization convention — readability at video resolution (Tufte, broadcast standards).',
    prior: { mu: 0.25, sigma: 0 },
    adaptive: false,
  },
  {
    id: 'dataviz-bar-radius',
    file: 'motion-graphics/engine/data-viz-renderers.tsx',
    value: 3,
    unit: 'px',
    controls: 'Bar corner radius',
    source: 'domain',
    sourceRef: 'Data visualization convention — readability at video resolution (Tufte, broadcast standards).',
    prior: { mu: 3, sigma: 0 },
    adaptive: false,
  ...
  {
    id: 'dataviz-ring-stroke-width',
    file: 'motion-graphics/engine/data-viz-renderers.tsx',
    value: 8,
    unit: 'px',
    controls: 'Ring/donut chart stroke width',
    source: 'domain',
    sourceRef: 'Data visualization convention — readability at video resolution (Tufte, broadcast standards).',
    prior: { mu: 8, sigma: 0 },
    adaptive: false,
  ...
  {
    id: 'dataviz-ring-bg-opacity',
    file: 'motion-graphics/engine/data-viz-renderers.tsx',
    value: 0.15,
    unit: 'ratio',
    controls: 'Ring chart background track opacity',
    source: 'domain',
    sourceRef: 'Data visualization convention — readability at video resolution (Tufte, broadcast standards).',
    prior: { mu: 0.15, sigma: 0 },
    adaptive: false,
  },
  {
    id: 'dataviz-spark-stroke-width',
    file: 'motion-graphics/engine/data-viz-renderers.tsx',
    value: 2,
    unit: 'px',
    controls: 'Sparkline stroke width',
    source: 'domain',
    sourceRef: 'Data visualization convention — readability at video resolution (Tufte, broadcast standards).',
    prior: { mu: 2, sigma: 0 },
    adaptive: false,
  ...
  {
    id: 'dataviz-spark-padding',
    file: 'motion-graphics/engine/data-viz-renderers.tsx',
    value: 4,
    unit: 'px',
    controls: 'Sparkline internal padding',
    source: 'domain',
    sourceRef: 'Data visualization convention — readability at video resolution (Tufte, broadcast standards).',
    prior: { mu: 4, sigma: 0 },
    adaptive: false,
  ...
  // ═══════════════════════════════════════════════════════════════════════════
  // COMPOSITION PLANNER — signal-triggered thresholds (composition-planner.ts)
  // ═══════════════════════════════════════════════════════════════════════════

  {
    id: 'enthusiasm-scale-pulse-trigger',
    file: 'motion-graphics/engine/composition-planner.ts',
    value: 0.8,
    unit: 'ratio',
    controls: 'enthusiasm above this + pacing > 0.6 triggers scale pulse',
    source: 'invented',
    sourceRef: 'No CRG or creative doc covers combined enthusiasm+pacing threshold for scale pulse',
    prior: { mu: 0.8, sigma: 0.16 },
    adaptive: true,
  },
  {
    id: 'warmth-breathe-trigger',
    file: 'motion-graphics/engine/composition-planner.ts',
    value: 0.6,
    unit: 'ratio',
    controls: 'warmth above this triggers breathe animation pattern',
    source: 'invented',
    sourceRef: 'No CRG or creative doc covers warmth-to-breathe mapping',
    prior: { mu: 0.6, sigma: 0.15 },
    adaptive: true,
  },
  {
    id: 'enthusiasm-float-trigger',
    file: 'motion-graphics/engine/composition-planner.ts',
    value: 0.4,
    unit: 'ratio',
    controls: 'enthusiasm above this triggers float animation pattern',
    source: 'invented',
    sourceRef: 'No CRG or creative doc covers enthusiasm-to-float mapping',
    prior: { mu: 0.4, sigma: 0.1 },
    adaptive: true,
  },
  {
    id: 'sparkline-min-values',
    file: 'motion-graphics/engine/composition-planner.ts',
    value: 5,
    unit: 'count',
    controls: 'Minimum numeric values to trigger sparkline detection',
    source: 'invented',
    sourceRef: 'No CRG or creative doc covers sparkline detection threshold',
    prior: { mu: 5, sigma: 1.25 },
    adaptive: true,
  },
  {
    id: 'budget-pattern-complexity',
    file: 'motion-graphics/engine/composition-planner.ts',
    value: 4,
    unit: 'count',
    controls: 'Element budget above which pattern complexity is unlocked',
    source: 'invented',
    sourceRef: 'No CRG or creative doc covers budget-to-complexity mapping',
    prior: { mu: 4, sigma: 1 },
    adaptive: true,
  },

  // ═══════════════════════════════════════════════════════════════════════════
  // PRIMITIVE RENDERERS — additional entries (primitive-renderers.ts)
  // ═══════════════════════════════════════════════════════════════════════════

  {
    id: 'follow-through-scale',
    file: 'motion-graphics/engine/primitive-renderers.ts',
    value: 0.04,
    unit: 'ratio',
    controls: 'Follow-through overshoot scale for secondary motion',
    source: 'crg',
    sourceRef: 'CRG overshoot 3-5%',
    aeRange: [0.03, 0.05],
    prior: { mu: 0.04, sigma: 0.005 },
    adaptive: true,
  },
  {
    id: 'beat-max-brightness',
    file: 'motion-graphics/engine/primitive-renderers.ts',
    value: 0.06,
    unit: 'ratio',
    controls: 'Max brightness filter increase on beat hit',
    source: 'invented',
    sourceRef: 'No CRG or AE source for max brightness cap on beat',
    prior: { mu: 0.06, sigma: 0.018 },
    adaptive: true,
  },
  {
    id: 'beat-rotation',
    ...
    value: 0.5,
    unit: 'degrees',
    controls: 'Rotation jitter on beat hit',
    source: 'invented',
    sourceRef: 'No CRG or AE source for beat-driven rotation',
    prior: { mu: 0.5, sigma: 0.15 },
    adaptive: true,
  },
  {
    id: 'exit-squash-factor',
    file: 'motion-graphics/engine/primitive-renderers.ts',
    value: 0.08,
    unit: 'ratio',
    controls: 'Scale squash divergence for exit animations',
    source: 'ae',
    sourceRef: 'AE practice: 5-10% divergence for exit squash',
    aeRange: [0.05, 0.1],
    prior: { mu: 0.08, sigma: 0.013 },
    adaptive: true,
  },
  ...
  // ═══════════════════════════════════════════════════════════════════════════
  // MOTION THEME RESOLVER — signal-to-property mappings (motion-theme-resolver.ts)
  // ═══════════════════════════════════════════════════════════════════════════

  {
    id: 'pitch-contour-stagger-multiplier',
    file: 'data/motion-theme-resolver.ts',
    value: 1.0,
    unit: 'multiplier',
    controls: 'pitch_contour signal → stagger timing multiplier',
    source: 'invented',
    sourceRef: 'No CRG source for pitch-to-stagger mapping',
    prior: { mu: 1.0, sigma: 0.25 },
    adaptive: true,
  },
  {
    id: 'music-section-chorus-stagger',
    file: 'data/motion-theme-resolver.ts',
    value: 0.8,
    unit: 'multiplier',
    controls: 'Chorus section → tighter stagger (faster entrances)',
    source: 'invented',
    sourceRef: 'No CRG source for section-to-stagger mapping',
    prior: { mu: 0.8, sigma: 0.2 },
    adaptive: true,
  },
  {
    id: 'speaking-rate-hold-blend',
    file: 'data/motion-theme-resolver.ts',
    value: 0.5,
    unit: 'weight',
    controls: 'speaking_rate_wpm → holdDuration blend factor',
    source: 'invented',
    sourceRef: 'No CRG source for speaking-rate-to-hold mapping',
    prior: { mu: 0.5, sigma: 0.15 },
    adaptive: true,
  },
  {
    id: 'early-position-density-reduction',
    file: 'data/motion-theme-resolver.ts',
    value: 0.7,
    unit: 'multiplier',
    controls: 'position_in_video early → reduce MG density (fewer graphics at start)',
    source: 'invented',
    sourceRef: 'No CRG source for position-based density adjustment',
    prior: { mu: 0.7, sigma: 0.18 },
    adaptive: true,
  },

  // ═══════════════════════════════════════════════════════════════════════════
  // BRAND COMPOSITION RULES (brand-composition-rules.ts)
  // ═══════════════════════════════════════════════════════════════════════════

  {
    id: 'brand-corner-radius-preference',
    file: 'motion-graphics/engine/brand-composition-rules.ts',
    value: 8,
    unit: 'px',
    controls: 'Default corner radius when no brand preference exists',
    source: 'domain',
    sourceRef: 'UI design convention — 6-10px corner radius standard for modern card/pill UI elements.',
    prior: { mu: 8, sigma: 2 },
    adaptive: true,
  },
  {
    id: 'brand-radius-font-ratio',
    file: 'motion-graphics/engine/brand-composition-rules.ts',
    value: 0.25,
    unit: 'ratio',
    controls: 'Corner radius as fraction of font size when deriving from typography',
    source: 'domain',
    sourceRef: 'Typography convention — corner radius proportional to font size for visual harmony.',
    prior: { mu: 0.25, sigma: 0.06 },
    adaptive: true,
  },
];
