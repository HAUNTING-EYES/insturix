...
// gemini-2.5-pro: thinking model, full video understanding, context caching supported.
// 2026-06-27: switched from gemini-3.1-pro-preview (pulled / 503). Must match the generation model.
// NOTE: gemini-2.5-flash earlier produced 246 jump_cuts / 27% coverage — keep this on the pro tier.
const CACHE_MODEL = 'models/gemini-2.5-pro'; // Must match the model used for generation
