...
export const MOMENT_SIGNAL_KEYS: MomentSignalKeySpec[] = [
  ...
  { key: 'visual.perception.semantic_window_count', channel: 'structure', level: 'primitive' },
  { key: 'visual.perception.ocr_text_count', channel: 'screen', level: 'primitive' },
  { key: 'visual.perception.ocr_text_sample', channel: 'screen', level: 'primitive' },
