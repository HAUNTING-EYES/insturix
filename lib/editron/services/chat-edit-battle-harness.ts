...
export const CHAT_EDIT_BATTLE_SCENARIOS: readonly ChatBattleScenario[] = [
  ...
  scenario('selected-dialogue-dubbing', 'Translate and dub selected dialogue', 'Translate and dub the selected video clip\'s spoken dialogue into English. Preserve the original speech timing, keep the background sound natural, and do not change the other clips.', { requiredToolSequence: ['dub_selected_dialogue', 'get_dubbing_job_result'], requireEvidenceBeforeMutation: false }),
