...
export const CHAT_EDIT_BATTLE_SCENARIOS: readonly ChatBattleScenario[] = [
  ...
  scenario('selected-dialogue-dubbing', 'Translate and dub selected dialogue', 'Translate and dub the selected video clip\'s spoken dialogue into English. Preserve the original speech timing, keep the background sound natural, and do not change the other clips.', { requiredToolSequence: [READ_PROJECT] }),
  scenario('vertical-subject-reframe', 'Reframe project while preserving subjects', 'Reframe this project to 9:16 and keep the main subject visible throughout every shot. Do not crop important on-screen text.', { requiredToolSequence: [READ_PROJECT] }),
