...
export const MEDIA_PROXY_MASTER_TRANSCODE_MAX_ATTEMPTS_V1 = 20;
export const MEDIA_PROXY_MASTER_TRANSCODE_MAX_RETENTION_MS_V1 =
  90 * 24 * 60 * 60 * 1_000;
const MAX_ATTEMPTS = MEDIA_PROXY_MASTER_TRANSCODE_MAX_ATTEMPTS_V1;
const MAX_RETENTION_MS = MEDIA_PROXY_MASTER_TRANSCODE_MAX_RETENTION_MS_V1;
