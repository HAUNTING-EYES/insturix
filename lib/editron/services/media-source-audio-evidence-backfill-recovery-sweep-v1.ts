...
export const MEDIA_SOURCE_AUDIO_EVIDENCE_BACKFILL_RECOVERY_CONTROLLER_KIND_V1 =
  'EDITRON_MEDIA_SOURCE_AUDIO_EVIDENCE_BACKFILL_RECOVERY_CONTROLLER_V1' as const;
export const MEDIA_SOURCE_AUDIO_EVIDENCE_BACKFILL_RECOVERY_SWEEP_KIND_V1 =
  'EDITRON_MEDIA_SOURCE_AUDIO_EVIDENCE_BACKFILL_RECOVERY_SWEEP_INTENT_V1' as const;
export const MEDIA_SOURCE_AUDIO_EVIDENCE_BACKFILL_RECOVERY_ATTEMPT_KIND_V1 =
  'EDITRON_MEDIA_SOURCE_AUDIO_EVIDENCE_BACKFILL_RECOVERY_ATTEMPT_V1' as const;
export const MEDIA_SOURCE_AUDIO_EVIDENCE_BACKFILL_RECOVERY_MAX_RUNS_V1 = 100;

export type MediaSourceAudioEvidenceBackfillRecoveryOrderCursorV1 = Readonly<{
  runUpdatedAt: string;
  migrationRunId: string;
}>;

export type MediaSourceAudioEvidenceBackfillRecoverySweepEntryV1 = Readonly<{
  migrationRunId: string;
  expectedRecordSha256: string;
  runUpdatedAt: string;
}>;

export type MediaSourceAudioEvidenceBackfillRecoveryControllerV1 = Readonly<{
  schemaVersion: 1;
  kind: typeof MEDIA_SOURCE_AUDIO_EVIDENCE_BACKFILL_RECOVERY_CONTROLLER_KIND_V1;
  controllerId: string;
  recordVersion: number;
  cursor: MediaSourceAudioEvidenceBackfillRecoveryOrderCursorV1 | null;
  cycleCount: number;
...
export type MediaSourceAudioEvidenceBackfillRecoverySweepIntentV1 = Readonly<{
  schemaVersion: 1;
  kind: typeof MEDIA_SOURCE_AUDIO_EVIDENCE_BACKFILL_RECOVERY_SWEEP_KIND_V1;
  controllerId: string;
  controllerRecordVersion: number;
  controllerRecordSha256: string;
  cursorBefore: MediaSourceAudioEvidenceBackfillRecoveryOrderCursorV1 | null;
  cursorAfter: MediaSourceAudioEvidenceBackfillRecoveryOrderCursorV1;
  wrapped: boolean;
  selectedAt: string;
  staleBefore: string;
  entries: readonly MediaSourceAudioEvidenceBackfillRecoverySweepEntryV1[];
  previousSweepIntentSha256: string | null;
  sweepIntentSha256: string;
}>;

export type MediaSourceAudioEvidenceBackfillRecoveryAttemptResultV1 = Readonly<{
  migrationRunId: string;
  expectedRecordSha256: string;
...
export type MediaSourceAudioEvidenceBackfillRecoveryAttemptV1 = Readonly<{
  schemaVersion: 1;
  kind: typeof MEDIA_SOURCE_AUDIO_EVIDENCE_BACKFILL_RECOVERY_ATTEMPT_KIND_V1;
  sweepIntentSha256: string;
  ...
  results: readonly MediaSourceAudioEvidenceBackfillRecoveryAttemptResultV1[];
...
export function createMediaSourceAudioEvidenceBackfillRecoveryControllerV1(
  input: Readonly<{ controllerId: string; createdAt: string }>,
): MediaSourceAudioEvidenceBackfillRecoveryControllerV1 {
  const createdAt = timestamp(input.createdAt);
  return freezeController({
    schemaVersion: 1,
    kind: MEDIA_SOURCE_AUDIO_EVIDENCE_BACKFILL_RECOVERY_CONTROLLER_KIND_V1,
...
export function selectMediaSourceAudioEvidenceBackfillRecoverySweepV1(
  ...
  nextController: MediaSourceAudioEvidenceBackfillRecoveryControllerV1;
}> {
  const current = assertMediaSourceAudioEvidenceBackfillRecoveryControllerV1(
    currentValue,
  );
  ...
  if (Date.parse(selectedAt) < Date.parse(current.updatedAt)
    ...
    || input.candidates.length
      > MEDIA_SOURCE_AUDIO_EVIDENCE_BACKFILL_RECOVERY_MAX_RUNS_V1) {
  ...
  const intent = freezeSweepIntent({
    schemaVersion: 1,
    kind: MEDIA_SOURCE_AUDIO_EVIDENCE_BACKFILL_RECOVERY_SWEEP_KIND_V1,
...
export function createMediaSourceAudioEvidenceBackfillRecoveryAttemptV1(
  intentValue: unknown,
  input: Readonly<{
    attemptNumber: number;
    previousAttemptSha256: string | null;
  ...
  return freezeAttempt({
    schemaVersion: 1,
    kind: MEDIA_SOURCE_AUDIO_EVIDENCE_BACKFILL_RECOVERY_ATTEMPT_KIND_V1,
...
export function assertMediaSourceAudioEvidenceBackfillRecoveryControllerV1(
  value: unknown,
): MediaSourceAudioEvidenceBackfillRecoveryControllerV1 {
...
export function assertMediaSourceAudioEvidenceBackfillRecoverySweepIntentV1(
  value: unknown,
): MediaSourceAudioEvidenceBackfillRecoverySweepIntentV1 {
...
export function assertMediaSourceAudioEvidenceBackfillRecoveryAttemptV1(
  value: unknown,
  intentValue?: unknown,
): MediaSourceAudioEvidenceBackfillRecoveryAttemptV1 {
...
function normalizeControllerMaterial(value: unknown): ControllerMaterialV1 {
  ...
  if (record.schemaVersion !== 1
    || record.kind
      !== MEDIA_SOURCE_AUDIO_EVIDENCE_BACKFILL_RECOVERY_CONTROLLER_KIND_V1) {
...
function normalizeSweepIntentMaterial(value: unknown): SweepIntentMaterialV1 {
  ...
  if (record.schemaVersion !== 1
    || record.kind
      !== MEDIA_SOURCE_AUDIO_EVIDENCE_BACKFILL_RECOVERY_SWEEP_KIND_V1
...
function normalizeAttemptMaterial(value: unknown): AttemptMaterialV1 {
  ...
  if (record.schemaVersion !== 1
    || record.kind
      !== MEDIA_SOURCE_AUDIO_EVIDENCE_BACKFILL_RECOVERY_ATTEMPT_KIND_V1
...
function normalizeSweepEntry(
  value: unknown,
): MediaSourceAudioEvidenceBackfillRecoverySweepEntryV1 {
...
function normalizeAttemptResult(
  value: unknown,
  expected?: MediaSourceAudioEvidenceBackfillRecoverySweepEntryV1,
...
function entryCursor(
  entry: MediaSourceAudioEvidenceBackfillRecoverySweepEntryV1,
): MediaSourceAudioEvidenceBackfillRecoveryOrderCursorV1 {
  return frozen({
...
function nullableCursor(
  value: unknown,
): MediaSourceAudioEvidenceBackfillRecoveryOrderCursorV1 | null {
...
function fail(code: string): never {
  throw new Error(
    'MEDIA_SOURCE_AUDIO_EVIDENCE_BACKFILL_RECOVERY_SWEEP_' + code,
  );
}
