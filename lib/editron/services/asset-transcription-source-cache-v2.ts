...
export const ASSET_TRANSCRIPTION_SOURCE_CACHE_COLLECTION_V2 =
  'asset_transcriptions_v2' as const;
export const ASSET_TRANSCRIPTION_SOURCE_BINDING_KIND_V2 =
  'EDITRON_ASSET_TRANSCRIPTION_SOURCE_BINDING_V2' as const;
export const ASSET_TRANSCRIPTION_SOURCE_CACHE_RECORD_KIND_V2 =
  'EDITRON_ASSET_TRANSCRIPTION_SOURCE_CACHE_RECORD_V2' as const;
export const ASSET_TRANSCRIPTION_CONTRACT_V2 =
