...
export async function runProviderStageV2(input: {
  ...
  const remaining = {
    input: limit.maxInputTokens, visible: limit.maxVisibleOutputTokens,
    reasoning: limit.maxReasoningTokens, wall: limit.maxWallClockMs, cost: limit.maxProviderCostUsd,
  };
