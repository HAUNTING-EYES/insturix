...
export function compileStage4ResearchProxyPreviewV2(
  ...
  const previewNode: JsonRecord = {
    ...
    intentNodeId: 'node-generated-island',
    ...
    traceRefs: [
      'node-generated-island', 'bind-reference-island', 'bind-source-media-and-windows',
      'bind-island-target-geometry', 'proof-rendered-geometry', 'proof-rendered-legibility',
      'proof-sandbox-compile', capabilityHash,
    ],
  };
  ...
  const unsigned: JsonRecord = {
    ...
    previewScope: {
      intentNodeIds: ['node-generated-island'],
      targetRange: capability.acceptedProfile.targetRange,
    ...
    diagnostics: [
      { code: 'FULL_PROJECT_DEPENDENCY_BLOCKED', intentNodeIds: ['node-native-continuation', 'node-proof'] },
    ],
    previewEligibleIntentNodeIds: ['node-generated-island'],
    unresolvedFullProjectIntentNodeIds: ['node-native-continuation', 'node-proof'],
    stateEffects: [],
  };
