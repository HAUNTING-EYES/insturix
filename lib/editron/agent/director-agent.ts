    ...
    };
    {
      ...
      try {
        ...
        if (storyboardId) {
          ...
          // Path B: SyntheticStoryboard (Mode 2: user footage → AI edits)
          // Generated by video-understanding-service.ts from Gemini Vision analysis.
          ...
          console.log(`[Director] Found SyntheticStoryboard with ${storyboardScenes.length} scenes (Mode 2 — user footage)`);
        }
      } catch (sbErr: any) {
