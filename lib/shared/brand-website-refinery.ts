...
export function createWebsiteBrandSignalProfile(input: BrandWebsiteDraftInput): BrandWebsiteSignalProfileResult {
  ...
  const profile: BrandSignalProfile = {
    ...
    voice: {
      ...
      recurringPhrases: makeSignal('voice.recurringPhrases', uniqueText([...parsed.ctas, ...parsed.headings]).slice(0, 8), source('website', 'website.headingsAndCtas', [...parsed.headings, ...parsed.ctas], [...parsed.headings, ...parsed.ctas], 0.55, 'voice_default')),
