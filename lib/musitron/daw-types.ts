...
const trackSchema = z.object({
  ...
  midiRegions: z.array(midiRegionSchema).optional().default([]),
  synthPatch: synthPatchSchema.optional().default(DEFAULT_SYNTH_PATCH),
  automationLanes: z.array(automationLaneSchema).optional().default([]),
  order: z.number().int().min(0),
