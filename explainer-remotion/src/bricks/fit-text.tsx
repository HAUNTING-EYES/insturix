...
// FIT TEXT — the only way words reach the screen. No fontSize prop, no color prop: size is COMPUTED
// (deterministic width estimation → binary-search fit inside the Region, greedy word-wrap, words
// never split), and colour comes from a closed `tone` enum mapped to brand tokens. Clipping and
// off-brand colour are unrepresentable through this API.
