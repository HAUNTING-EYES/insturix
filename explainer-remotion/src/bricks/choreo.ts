...
// CHOREO — time as a computed quantity. A scene's arc is four PHASES derived from its duration and
// the brand's motion energy; elements anchor to phases (never to hand-typed frame windows), enter
// through a small verb set whose physics come from brand.motion, and hit on the beat grid. GLM
// composes VERBS + ANCHORS; every number is derived.
