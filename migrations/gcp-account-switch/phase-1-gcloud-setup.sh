...
echo "     insturix-prod-sa-key.json \\"
echo "     --iam-account=$SERVICE_ACCOUNT_EMAIL \\"
echo "     --project=$PROJECT_ID"
echo ""
echo "   This creates 'insturix-prod-sa-key.json' in the current directory."
echo "   KEEP THIS FILE SECRET. Do NOT commit to git."
echo ""
echo "2. Base64-encode the key for Vercel env var:"
echo ""
echo "   Windows (PowerShell):"
echo "     [Convert]::ToBase64String([IO.File]::ReadAllBytes('insturix-prod-sa-key.json'))"
echo ""
echo "   Windows (Git Bash):"
echo "     base64 -w 0 insturix-prod-sa-key.json > insturix-prod-sa-key.b64"
echo ""
